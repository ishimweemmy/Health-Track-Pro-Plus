...
const Sidebar = (props: {
  ...
  return (
    <div
      className={`w-[15%] sm:none duration-175 linear fixed !z-50 flex min-h-full flex-col bg-white pb-10 shadow-3xlxl shadow-shadow-500 transition-all dark:!bg-navy-800 dark:text-white md:!z-50 lg:!z-50 xl:!z-0 mt-[2rem] ml-[2rem] rounded-xl ${
